...
\subsection*{📈 Key Statistical Insights}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{../DatasetAnalysis/target_histograms.eps}
\end{center}
The histograms show the distribution of our two target variables. \texttt{Collection} displays a right-skewed distribution typical of box office revenue, while \texttt{Start\_Tech\_Oscar} shows the class imbalance between winners and non-winners.

\subsubsection*{Box Office Collection Relationships}
\begin{center}
\includegraphics[width=0.9\textwidth]{../DatasetAnalysis/collection_scatters.eps}
\end{center}
Scatter plots reveal strong positive correlations between box office collection and key features like budget, marketing expense, and trailer views. The relationship with critic ratings appears more nuanced.

\subsubsection*{Technical Award Predictive Features}
\begin{center}
\includegraphics[width=0.9\textwidth]{../DatasetAnalysis/oscar_boxplots.eps}
\end{center}
Box plots comparing Oscar winners vs non-winners show significant differences in budget, critic ratings, and director ratings. Award-winning films tend to have higher production values and critical acclaim.

\subsubsection*{Genre Performance Analysis}
\begin{center}
\includegraphics[width=0.9\textwidth]{../DatasetAnalysis/genre_analysis.eps}
\end{center}
Genre analysis reveals Action films lead in average box office collection, while Thriller films have the highest technical award win rate, suggesting different success patterns across genres.

\subsubsection*{3D Format Impact}
\begin{center}
\includegraphics[width=0.9\textwidth]{../DatasetAnalysis/threed_analysis.eps}
\end{center}
3D films show both higher average box office returns and significantly higher technical award win rates, indicating the format's impact on both commercial and critical success.
