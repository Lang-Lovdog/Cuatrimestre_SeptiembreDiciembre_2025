% Add this to your main file or a new include file
...
\begin{frame}{Timeline \& Deliverables}
\blurbackground
\begin{columns}
...
\begin{tcolorbox}[
    ...
    arc=3mm,
    boxrule=1pt,
    title={\color{mypurple}6-Month Timeline}
]
\textbf{Months 1-2:}
\begin{itemize}
    \item EXP-1, EXP-2 (reproduction studies)
    \item Baseline implementation
\end{itemize}

\textbf{Months 3-4:}
\begin{itemize}
    \item EXP-3, EXP-4 (algorithm comparison)
    \item Stability testing
\end{itemize}

\textbf{Month 5:}
\begin{itemize}
    \item EXP-5, EXP-6 (boundary mapping)
